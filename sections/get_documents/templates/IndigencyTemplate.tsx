...
function IndigencyTemplate(props: IndigencyProps) {
    ...
    <Document>
      <Page style={styles.body}>
        ...
        <Text style={styles.text}>
          {`This is to certify that ${firstName} ${middleName} ${lastName}, ${age} years of age, (Single/married/widow/er) is a Filipino citizen, a bonafide resident of this barangay.`}
        </Text>
        <Text style={styles.text}>
          This further certifies that the person whose name appears above, has
          not enough resources to support their financial needs, they deserve
          assistance from concerned government agencies, they belong to indigent
          residence of this Barangay.
        </Text>
        <Text style={styles.text}>
