...
function SamahanProjectList() {
  ...
  return (
    <>
      <SectionTitle
        title="Samahan Projects"
        description="Here are some of the efforts made by the Samahan"
      />
...
export default SamahanProjectList;
