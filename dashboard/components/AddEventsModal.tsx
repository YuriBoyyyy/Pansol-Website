...
function AddEventsModal(props: ComProps) {
  ...
  const handlePost = async () => {
      ...
      AddDocument("events", data)
        .then((res) => {
          ...
          toast({
            title: "Event Posted!",
            description:
              "The community can now see the details of the upcoming event.",
            status: "success",
            duration: 3000,
            isClosable: true,
            position: "top",
    ...
    mails.forEach(async (mail) => {
      await addDoc(mailCollectionRef, {
        message: {
          html: "Pansol posted new event. Check it out! https://pansol-website.vercel.app/events ",
